...
if is_core_basic:
    ...
    from .core_basic import add, sub, rsub, mul, div, rdiv, exp, pow, square, neg, sin
    ...
    from .core import Add, Sub, Mul, Div, Exp, Pow, Square, Neg, Sin
    from .core import add, sub, rsub, mul, div, rdiv, exp, pow, square, neg, sin
